...
public class TicTacToe{
    ...
    static JButton button32 = new JButton(" ");    static JButton button13 = new JButton(" ");

static JLabel statusLabel = new JLabel("O starting first GOOD LUCK !");
...
//3 LINE
    ...
    statusLabel.setBounds(50, 10, 400, 30);
    statusLabel.setHorizontalAlignment(SwingConstants.CENTER);

    // Add reset button
    panel.add(resetButton);
    resetButton.setBounds(200, 410, 100, 30);
...
public static void resetGame() {
    JButton[] buttons = {button1, button2, button3, button12, button22, button32, button13, button23, button33};
    for (JButton button : buttons) {
        button.setText("");
        button.setEnabled(true);
    }
    syc = 1;
    statusLabel.setText("O starting first GOOD LUCK !");
}
